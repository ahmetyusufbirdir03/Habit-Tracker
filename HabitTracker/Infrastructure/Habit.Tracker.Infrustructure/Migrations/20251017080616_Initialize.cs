        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_habit_groups_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletedDaysCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_habits_habit_groups_HabitGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_habit_daily_schedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_habit_daily_schedules_habits_HabitId",
                        column: x => x.HabitId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_habit_monthly", x => x.Id);
                    table.ForeignKey(
                        name: "FK_habit_monthly_habits_HabitId",
                        column: x => x.HabitId,
                        principalTable: "habits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_habit_weekly_schedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_habit_weekly_schedules_habits_HabitId",
                        column: x => x.HabitId,
                        principalTable: "habits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_habit_daily_schedules_HabitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_habit_groups_UserId",
                table: "habit_groups",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_habit_monthly_HabitId",
                table: "habit_monthly",
                column: "HabitId");

            migrationBuilder.CreateIndex(
                name: "IX_habit_weekly_schedules_HabitId",
